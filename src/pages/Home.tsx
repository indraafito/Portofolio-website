          ...
          <div className="max-w-6xl mx-auto">
            <div data-aos="fade-up">
              <div className="flex items-center justify-between mb-12">
                <div>
                  <h2 className="text-4xl font-bold glow-text mb-2">Education</h2>
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="max-w-6xl mx-auto">
            <div data-aos="fade-up">
              <div className="flex items-center justify-between mb-12">
                <div>
                  <h2 className="text-4xl font-bold glow-text mb-2">Featured Projects</h2>
                    ...
                    {project.technologies && project.technologies.length > 0 && (
                      <div className="flex flex-wrap gap-2 mb-4">
                        {project.technologies.slice(0, 3).map((tech, i) => (
                          <Badge key={i} variant="secondary" className="border border-primary/30 text-xs">
                            {tech}
                          </Badge>
                        ))}
                        {project.technologies.length > 3 && (
                          <Badge variant="secondary" className="border border-primary/30 text-xs">
                            +{project.technologies.length - 3}
                          </Badge>
                        )}
                      </div>
